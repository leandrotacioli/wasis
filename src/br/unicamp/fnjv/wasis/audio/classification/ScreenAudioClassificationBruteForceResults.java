 ...
 * @version 3.0 - 04/Abr/2018
 */
public class ScreenAudioClassificationBruteForceResults {
	 ...
	 */
	protected ScreenAudioClassificationBruteForceResults(List<PearsonCorrelationValues> lstValuesX, List<PearsonCorrelationValues> lstValuesY, String strAnimalIdY) {
		this.lstValuesX = lstValuesX;
		this.lstValuesY = lstValuesY;
		this.strAnimalIdY = strAnimalIdY;
	...
	private void loadScreen() {
		...
		LTTextField txtFilePathX = new LTTextField("Arquivo:", LTDataTypes.STRING, false, false, 200);
		LTTextField txtAnimalIdX = new LTTextField("", LTDataTypes.STRING, false, false, 200);
		...
		LTTextField txtAnimalIdY = new LTTextField("", LTDataTypes.STRING, false, false, 200);
		...
		panelSampleX.add(txtAnimalIdX, "cell 0 1, grow");
		
		panelSampleY.add(txtFilePathY, "cell 0 0, grow");
		panelSampleY.add(txtAnimalIdY, "cell 0 1, grow");
	...
	private XYDataset createDataset() {
		...
		XYSeries xySeriesX = new XYSeries("Espécie a ser identificada");
        XYSeries xySeriesY = new XYSeries("" + strAnimalIdY);
